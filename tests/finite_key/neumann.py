...
class secure_key_rates:
    ...
    def set_darkcounts(self, DC_A, DC_B) -> None:
    ...
    def set_jitter(self, t_delta) -> None:
    ...
    def set_dead_time(self, t_dead_A, t_dead_B) -> None:
    ...
    def __coincidence_window_loss__(self, x, j, k) -> float:
