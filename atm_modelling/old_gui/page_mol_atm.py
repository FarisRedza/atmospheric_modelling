...
from atm_modelling.libRadtranPy import mol_atm
...
class MolAtm(Adw.PreferencesPage):
    ...
    def on_atmosphere_select(self, dropdown: Gtk.DropDown, _):
        self.selected_atmosphere = dropdown.get_selected()

    def on_ck_scheme_select(self, dropdown: Gtk.DropDown, _):
        self.selected_ck_scheme = dropdown.get_selected()

    def on_mol_abs_param_str_clear(self, entry: Gtk.Entry, _):
        self.mol_abs_param_str_entry.set_text(text='')

    def on_mol_modify_clear(self, entry: Gtk.Entry, _):
        self.mol_modify_entry.set_text(text='')

    def on_mol_id_select(self, dropdown: Gtk.DropDown, _):
        self.selected_mol_id = dropdown.get_selected()

    def on_crs_model_select(self, dropdown: Gtk.DropDown, _):
