...
class MonteCarlo:
    mc_polarisation: MCPolarisation | None = None
    mc_backward_output: MCBackwardOutput | None = None
    mc_forward_output: MCForwardOutput | None = None
    mc_output_unit: MCOutputUnit | None = None
